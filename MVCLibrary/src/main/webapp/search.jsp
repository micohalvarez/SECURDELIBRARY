                    ...
                    <div class="col-sm-11 m-3">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item">
                                ...
                                <a href="#">
                                    <p class="pl-3">Harry Potter and the Chamber of Secrets</p>
                                </a>
                            </li>
                            <li class="list-group-item">
                                <img src="img/book.png">
                                <a href="#">
                                    <p class="pl-3">Catching Fire</p>
                                </a>
                            </li>
                            <li class="list-group-item">
                                <img src="img/magazine.png">
                                <a href="#">
                                    <p class="pl-3">Cosmopolitan June 2017</p>
                                </a>
                            </li>
                            <li class="list-group-item">
                                <img src="img/book.png">
                                <a href="#">
                                    <p class="pl-3">Introduction to Natural Language Processing</p>
                                </a>
                            </li>
                            <li class="list-group-item">
                                <img src="img/book.png">
                                <a href="#">
                                    <p class="pl-3">Harry Potter and the Prisoner of Azkaban</p>
                                </a>
                            </li>
                        </ul>
                    </div>
